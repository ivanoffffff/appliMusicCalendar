  ...
  return (
    <div className="min-h-screen mesh-bg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-28 md:pb-16">
        ...
        {/* Onglets par type */}
        {artist.releases.length > 0 && (
          <div className="sticky top-14 md:top-0 z-40 -mx-4 sm:-mx-6 px-4 sm:px-6 py-2.5 mb-6 bg-[rgb(var(--bg-primary))]/90 backdrop-blur-xl border-b border-gray-100 dark:border-white/5">
