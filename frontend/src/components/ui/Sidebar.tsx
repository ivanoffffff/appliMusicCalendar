...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="hidden md:flex fixed left-0 top-0 h-full w-60 z-50 flex-col">
      {/* Glass background */}
      ...
      <div className="relative flex flex-col h-full px-3 py-5">
        ...
        >
          ...
          <span className="text-base font-black gradient-text">Music Tracker</span>
        </button>

        {/* ── Navigation ── */}
        <nav className="flex flex-col gap-1 flex-1">
          <p className="text-[10px] font-bold text-secondary uppercase tracking-widest px-3 mb-2">Navigation</p>
          {NAV_ITEMS.map(({ path, label, Icon }) => {
            ...
            return (
              <button
                ...
                className={`relative flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 cursor-pointer group ${
                  active
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            onClick={toggleTheme}
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-secondary hover:text-primary hover:bg-gray-100/80 dark:hover:bg-white/5 transition-all duration-200 cursor-pointer"
          ...
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-100/80 dark:hover:bg-white/5 transition-all duration-200 cursor-pointer group"
          ...
          >
            ...
            <SettingsIcon className="w-4 h-4 text-secondary group-hover:text-primary transition-colors shrink-0" />
          </button>
        </div>
      </div>
    </aside>
